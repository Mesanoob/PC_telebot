...
SECTION_MAP = [
    ...
    (
        ["fire", "fire safety", "fire code", "fire alarm", "fire extinguisher",
         "sprinkler", "hose reel", "smoke detector", "smoke alarm",
         "means of escape", "exit staircase", "evacuation", "evacuate",
         "fire escape", "escape route", "fire door", "fire rated",
         "fire hydrant", "fire engine", "scdf", "fire hazard",
         "emergency lighting", "exit sign", "fire drill",
         "lpg", "gas cylinder", "bbq fire", "fire compartment",
         "fire resistance", "separating wall", "purpose group",
         "fire certificate", "fire safety certificate", "fsc",
         "fire emergency", "burn", "smoke", "extinguish",
         # Battery & charging
         "battery", "lithium", "lithium-ion", "li-ion", "energy storage",
         "ess", "power bank", "charging", "ev charger", "ev charging",
         "electric vehicle", "electric car", "tesla", "car charger",
         "solar panel", "solar pv", "pv installation",
         "battery fire", "battery explode", "battery safety",
         "e-scooter fire", "pmd fire", "battery storage",
         # Additional fire & building keywords
         "scdf", "singapore civil defence", "civil defence",
         "guideline", "guidelines", "fire guideline", "scdf guideline",
         "staircase", "exit staircase", "fire staircase", "stairwell",
         "corridor", "fire corridor", "common corridor",
         "walkway", "covered walkway", "linkway",
         "fire safety requirement", "fire precaution",
         "fire exit", "fire door", "fire rated door",
         "block corridor", "obstruct", "obstruction", "clutter",
         "store items", "items in corridor", "items in staircase",
         # Common corridor obstruction items
         "shoe", "shoes", "shoe rack", "shoerack", "footwear", "slippers",
         "table", "chair", "stool", "bench", "furniture",
         "plant", "potted plant", "flower pot", "boxes", "cardboard",
         "bicycle", "pmd", "scooter", "trolley", "pram", "stroller"],
        "fire_safety.txt",
    ),
    (
